    ...
    public class EmpleadosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Empleados != null ? 
                          ...
                          Problem("Entity set 'DbEmpleadosContext.Empleados'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Edad,Departamento,Salario")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Edad,Departamento,Salario")] Empleado empleado)
        {
            if (id != empleado.Id)
            {
                return NotFound();
